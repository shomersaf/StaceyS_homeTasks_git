function getAbout() {
  ...
  projectAuthorP1.innerHTML =
    "<strong>Stacey Steshin</strong> - BSc(Econ), MSc(Eng), CG artist and designer, student of Full Stack Development Course in John Bryce College, Tel Aviv.";
  projectAuthorP2.innerHTML = `<a href="https://staceysteshin.artstation.com/" target="_blank">Personal page on Artstation</a>`;
  projectAuthor.append(
    image,
    projectAuthorH4,
    projectAuthorP1,
    projectAuthorP2
